...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="nav-links">
      <a href="/Proyecto-programaci-n-web/vistas/Organizador/dashboard.php" class="nav-item"><i class="fa-solid fa-house"></i> Dashboard</a>
      <a href="/Proyecto-programaci-n-web/vistas/Organizador/perfil/ver.php" class="nav-item"><i class="fa-solid fa-user-gear" style="color:#c84dff;"></i> Mi perfil</a>
      <a href="/Proyecto-programaci-n-web/vistas/Organizador/torneo/mis-torneos.php" class="nav-item"><i class="fa-solid fa-trophy" style="color:#ffb84d;"></i> Mis Torneos</a>
      <a href="/Proyecto-programaci-n-web/vistas/Organizador/ranking.php" class="nav-item"><i class="fa-solid fa-ranking-star" style="color:#ffb84d;"></i> Ranking</a>
      <a href="/Proyecto-programaci-n-web/vistas/Organizador/solicitudes.php" class="nav-item"><i class="fa-solid fa-bell" style="color:#ff4d94;"></i> Solicitudes</a>
    </nav>
